...
const CONTRACT_NAME: &str = "crates.io:music-nft";
...
pub struct Metadata {
    ...
    pub audio_track_url: Option<String>,
}
...
mod tests {
    ...
    fn use_metadata_extension() {
        ...
        let extension = Some(Metadata {
            ...
            audio_track_url: Some("https://example.com/bohemian_rhapsody.mp3".to_string()),
            ..Metadata::default()
        });
